...
class AppColors {
  ...
  static const Color shadedBlackColor=Color(0x33121312);
  static const Color whiteColor=Color(0xffFFFFFF);
  static const Color whiteColor60Per=Color(0x99FFFFFF);
  static const Color darkGreyColor=Color(0xff282A28);
  static const Color redColor=Color(0xffE82626);
  static const  Color primaryColorLight =Color(0x8FF6BD00);
  static const Color transparentColor=Colors.transparent;
  static const Color lightGreyColor = Color(0xB5121312);
