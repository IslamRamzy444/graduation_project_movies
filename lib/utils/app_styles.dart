...
class AppStyles {
  static TextStyle medium36White = GoogleFonts.inter(
      fontWeight: FontWeight.w500, fontSize: 36, color: AppColors.whiteColor);
  static TextStyle regular20GreyWhite = GoogleFonts.inter(
      fontWeight: FontWeight.w400,
      fontSize: 20,
      color: AppColors.whiteColor60Per);
  ...
  static TextStyle regular20DarkGreyRoboto = GoogleFonts.roboto(
      fontWeight: FontWeight.w400,
      fontSize: 20,
  ...
  static TextStyle regular14PrimaryRoboto = GoogleFonts.roboto(
      fontWeight: FontWeight.w400, fontSize: 14, color: AppColors.primaryColor);
  static TextStyle regular16PrimaryRoboto = GoogleFonts.roboto(
      fontWeight: FontWeight.w400, fontSize: 16, color: AppColors.primaryColor);
  static TextStyle regular16BlackRoboto = GoogleFonts.roboto(
      fontWeight: FontWeight.w400, fontSize: 16, color: AppColors.blackColor);
  ...
  static TextStyle semiBold20Primary = GoogleFonts.inter(
      fontWeight: FontWeight.w600, fontSize: 20, color: AppColors.primaryColor);
