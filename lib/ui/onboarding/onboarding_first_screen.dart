        ...
        child: Column(
          ...
          children: [
            RichText(
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                    text:
                        "${AppLocalizations.of(context)!.boarding_title_one}\n",
            ...
            CustomElevatedButton(
                buttonText: AppLocalizations.of(context)!.explore_now,
                onPressed: () {
                  Navigator.pushReplacementNamed(
                      context, AppRoutes.introScreenRouteName);
                }),
          ],
        ),
      ),
