...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  bool obscured2=true;
  List<String> avatars=[
    AppAssets.avatar2,AppAssets.avatar1,AppAssets.avatar3,AppAssets.avatar4,AppAssets.avatar5,AppAssets.avatar6,AppAssets.avatar7,AppAssets.avatar8,AppAssets.avatar9
  ];
  @override
